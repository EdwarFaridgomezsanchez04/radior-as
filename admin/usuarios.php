    ...
    switch ($_POST['action']) {
        case 'toggle_status':
            ...
            if ($id != $_SESSION['user_id']) {
                // Obtener info del usuario antes de cambiar
                ...
                $nuevo_estado = $user_info['activo'] ? 'inactivo' : 'activo';
                $historial->registrar('update', 'usuario', 'Cambió estado de usuario a ' . $nuevo_estado, [
                    'usuario_id' => $_SESSION['user_id'],
                    'usuario_nombre' => $_SESSION['username'],
                    'entidad_id' => $id,
                    'entidad_nombre' => $user_info['username'],
                    'detalles' => [
                        'estado_anterior' => $user_info['activo'] ? 'activo' : 'inactivo',
        ...
        case 'change_role':
            ...
            if ($id != $_SESSION['user_id'] && in_array($new_role, ['admin', 'editor'])) {
                ...
                // Registrar en historial
                $historial->registrar('update', 'usuario', 'Cambió rol de usuario', [
                    'usuario_id' => $_SESSION['user_id'],
                    'usuario_nombre' => $_SESSION['username'],
                    'entidad_id' => $id,
                    'entidad_nombre' => $user_info['username'],
                    'detalles' => [
                        'rol_anterior' => $user_info['rol'],
                        'rol_nuevo' => $new_role
                    ]
                ]);
            }
        ...
        case 'delete':
            ...
            if ($id != $_SESSION['user_id']) {
                ...
                // Registrar en historial
                $historial->registrar('delete', 'usuario', 'Eliminó usuario', [
                    'usuario_id' => $_SESSION['user_id'],
                    'usuario_nombre' => $_SESSION['username'],
                    'entidad_id' => $id,
                    'entidad_nombre' => $user_info['username'],
